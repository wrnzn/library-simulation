...
code_cell_1 = """try:
    import piplite
    await piplite.install(['simpy', 'seaborn', 'scipy', 'pandas', 'matplotlib'])
    print("Pyodide (JupyterLite) environment detected. Dependencies installed.")
except ImportError:
    pass
...
with open(r"D:\Codes 2\simpy\Library_Simulation_v2.ipynb", "w", encoding='utf-8') as f:
